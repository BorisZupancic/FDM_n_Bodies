...
L, mu, Num_bosons, r, sigma, Num_stars = GF.StartupV3(hbar, L_s, v_s)
m = mu*M_s
...
absolute_PLOT = True
track_centroid = True
stars, chi, E_storage, centroids = GF.run_FDM_n_Bodies(sim_choice2, z,L,dz,mu, Num_bosons, r, sigma,Num_stars,v_s,L_s,Directory,folder_name, track_stars = True, track_centroid = True, Long_time = True)
...
np.savetxt(f"Centroids_m{m}.csv",centroids,delimiter = ',')
